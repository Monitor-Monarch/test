...
public class pacman {
    ...
    private Richtungen bewegungsRichtung = Richtungen.oben;
    ...
    public Richtungen getBewegungsRichtung() {return bewegungsRichtung;}
    public void setBewegungsRichtung(Richtungen bewegungsRichtung) {
...
//        }
    ...
    public pacman(int posX, int posY, Richtungen richtung, int geschwindigkeit) {
        x = posX;
        y = posY;
    ...
    private void move(Richtungen richtung) {
        switch (richtung) {
            case oben -> addY(-1);
            case rechts -> addX(1);
            case unten -> addY(1);
